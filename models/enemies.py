...
ENEMIES = {
    ...
    "склад_17": [
        {
            "name": "🧟 Складской зомби",
            "description": "Бывший техник снабжения, застрявший между стеллажами Склад-17.",
            "hp": 70,
            "damage": 18,
            "chance": 38,
        },
        {
            "name": "🔫 Бункерный мародёр",
            "description": "Сталкер, который пришёл за деталями и не собирается делиться.",
            "hp": 85,
            "damage": 22,
            "chance": 32,
        },
        {
            "name": "🤖 Сломанный охранный дрон",
            "description": "Дрон старой системы охраны, который всё ещё стреляет по движению.",
            "hp": 65,
            "damage": 26,
            "chance": 20,
        },
        {
            "name": "🧰 Фонящий техник",
            "description": "Полумёртвый ремонтник с инструментами и тяжёлым ключом.",
            "hp": 95,
            "damage": 24,
            "chance": 10,
        },
