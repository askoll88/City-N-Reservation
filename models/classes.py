...
_DEFAULT_CLASSES = {
    ...
    "охотник": {
        ...
        "passive_skills": [
            ...
            {"name": "Разделка добычи", "required_level": 35, "description": "каждый удар идёт туда, где живое ломается быстрее; +6% урона оружием, ножи дополнительно получают +10% урона от силы", "weapon_damage": 6, "knife_damage": 10},
