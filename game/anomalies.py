...
DEVICES = {
    ...
    "Детектор-Х": {
        "description": "Экспериментальный прибор с упором на редкие артефактные следы.",
    ...
    "Детектор Аномалист-2": {
        "description": "Апгрейд Детектора-Х: стабильнее в поле и лучше как универсальный прибор.",
        "bonus": "+29% базово, до +34% для редких артефактов",
        "effect": "anomalist_2",
        "bonus_value": 29,
        "rare_bonus": 34,
        "weight": 0.6,
    ...
    "Детектор Мираж-Альфа": {
        "description": "Апгрейд Аномалиста-2 для пси-активных артефактов.",
        "bonus": "+31% базово, до +38% для пси-активных артефактов, до +36% для редких",
        "effect": "mirage_alpha",
        "bonus_value": 31,
        "bonus_type": "psi",
        "type_bonus": 38,
    ...
    "Око Зоны": {
        ...
        "bonus": "+36% базово, до +45% в скоплении аномалий, до +40% для редких",
        "effect": "oko_zony",
        "bonus_value": 36,
        "rare_bonus": 40,
        "cluster_bonus": 45,
