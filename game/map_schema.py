...
LOCATION_METADATA: dict[str, dict[str, Any]] = {
    ...
    "склад_17": {
        ...
        "level_max": 12,
        "danger": "medium",
        "tags": ["dungeon", "military", "weapon_upgrade", "materials", "bunker", "threat"],
        "requires": {},
        "activities": ["dungeon", "combat", "weapon_upgrade_materials", "threat_select"],
    ...
    "заимка_лесника": {
        ...
        "level_max": 18,
        "danger": "safe",
        "tags": ["safe", "forest", "npc", "hunting", "trophy", "quest"],
        "requires": {},
        "activities": ["talk", "rest", "hunting_unlock", "trophy_sell"],
        "loot_profile": None,
    },
    "охотничьи_угодья": {
        "region": "forest",
        ...
        "level_max": 22,
        "danger": "medium",
        "tags": ["forest", "hunting", "afk", "trophy", "animals", "mutants"],
        "requires": {"quest_flag": "forest_hunting_grounds_unlocked"},
