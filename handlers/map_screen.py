...
MAP_REGIONS: dict[str, MapRegion] = {
    ...
    "forest": MapRegion(
        id="forest",
        label="Лес",
        location_ids=("дорога_зараженный_лес", "заимка_лесника", "охотничьи_угодья", "зараженный_лес"),
        route_target="дорога_зараженный_лес",
        description="Лесная ветка за КПП: заражённая тропа, заимка лесника, следы стаи и чаща, которая не любит чужой шум.",
    ),
}
