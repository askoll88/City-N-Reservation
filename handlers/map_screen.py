...
MAP_REGIONS: dict[str, MapRegion] = {
    ...
    "military": MapRegion(
        ...
        description="Старый военный сектор за КПП: ржавые блокпосты, патрули, внутренний периметр части и оружейный бункер Склад 17.",
    ),
    "science": MapRegion(
        id="science",
        label="НИИ",
    ...
    "forest": MapRegion(
        id="forest",
        label="Лес",
        location_ids=("дорога_зараженный_лес", "заимка_лесника", "охотничьи_угодья", "зараженный_лес", "турбаза_лучик", "озеро"),
        route_target="дорога_зараженный_лес",
        description="Лесная ветка за КПП: заражённая тропа, заимка лесника, чаща, турбаза Лучик и озеро.",
    ),
}
...
LOOT_PROFILE_LABELS = {
    ...
    "warehouse_17": "материалы прорыва оружия, оружейный опыт, калибровочные наборы",
    ...
    "lake_fishing": "рыба, озёрный мусор, редкие полезности",
}
...
LOCATION_COMMAND_LABELS = {
    ...
    "охотничьи_угодья": "Охотничьи угодья",
    "зараженный_лес": "Зараженный лес",
    "турбаза_лучик": "Турбаза Лучик",
    "озеро": "Озеро",
}
